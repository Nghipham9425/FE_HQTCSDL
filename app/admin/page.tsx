...
export default async function AdminDashboardPage() {
  ...
  const cards = [
    { label: "Products", value: stats.products, href: "/admin/products", icon: Boxes },
    { label: "Categories", value: stats.categories, href: "/admin/categories", icon: Shapes },
    { label: "TCG Cards", value: stats.tcgCards, href: "/admin/tcg-cards", icon: Tag },
    { label: "TCG Sets", value: stats.tcgSets, href: "/admin/tcg-sets", icon: Tag },
    { label: "Vouchers", value: stats.vouchers, href: "/admin/vouchers", icon: Gift },
    { label: "Payment Methods", value: stats.paymentMethods, href: "/admin/payment-methods", icon: CreditCard },
  ];
    ...
    <div className="space-y-6">
      <section className="rounded-3xl border border-indigo-200 bg-gradient-to-r from-indigo-600 to-blue-500 p-6 text-white shadow-lg dark:border-indigo-800/60">
        ...
        <p className="mt-2 text-sm text-indigo-100">
          Quản lý dữ liệu cửa hàng theo mô hình CRUD, đồng bộ trực tiếp với .NET API.
        </p>
      </section>
        ...
        {cards.map((card) => {
          ...
          return (
            ...
            >
              ...
              <p className="mt-1 text-3xl font-black tracking-tight">{card.value.toLocaleString("vi-VN")}</p>
